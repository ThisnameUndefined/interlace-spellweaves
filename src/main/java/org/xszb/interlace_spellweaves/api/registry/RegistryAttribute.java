...
public class RegistryAttribute {
    ...
    public static final RegistryObject<Attribute> HEAL_MUL = ATTRIBUTES.register("heal_mul", () -> (new MagicRangedAttribute("attribute.iss_cws.heal_mul", 1.0D, -1024.0D, 1000000.0D).setSyncable(true)));
    public static final RegistryObject<Attribute> ARROW_MUL = ATTRIBUTES.register("arrow_mul", () -> (new MagicRangedAttribute("attribute.iss_cws.arrow_mul", 1.0D, -1024.0D, 1000000.0D).setSyncable(true)));
