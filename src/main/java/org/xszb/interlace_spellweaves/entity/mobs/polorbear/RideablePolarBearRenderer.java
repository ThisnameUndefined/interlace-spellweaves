...
public class RideablePolarBearRenderer extends MobRenderer<PolarBear, PolarBearModel<PolarBear>> {
    private static final ResourceLocation BEAR_LOCATION = ResourceLocation.fromNamespaceAndPath(InterlaceSpellWeaves.MODID,"textures/entity/bear/polarbear.png");

    public RideablePolarBearRenderer(EntityRendererProvider.Context p_174356_) {
