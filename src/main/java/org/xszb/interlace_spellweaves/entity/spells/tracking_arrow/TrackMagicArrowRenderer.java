...
@OnlyIn(Dist.CLIENT)
public class TrackMagicArrowRenderer extends EntityRenderer<TrackMagicArrow> {
    private static final ResourceLocation TEXTURE = IronsSpellbooks.id("textures/entity/small_magic_arrow.png");

    public TrackMagicArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(TrackMagicArrow entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(TrackMagicArrow entity) {
