...
public class DamageGustRenderer extends EntityRenderer<DamageGustCollider> {
    ...
    public DamageGustRenderer(Context context) {
        super(context);
    ...
    @Override
    public void render(DamageGustCollider entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(DamageGustCollider entity) {
        return TEXTURE;
    }
