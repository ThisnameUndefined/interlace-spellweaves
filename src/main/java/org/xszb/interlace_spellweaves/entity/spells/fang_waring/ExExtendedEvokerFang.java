package org.xszb.interlace_spellweaves.entity.spells.fang_waring;
...
public class ExExtendedEvokerFang extends EvokerFangs implements AntiMagicSusceptible {
    ...
    public ExExtendedEvokerFang(Level pLevel, double pX, double pY, double pZ, float pYRot, int pWarmupDelay, LivingEntity pOwner, float damage) {
