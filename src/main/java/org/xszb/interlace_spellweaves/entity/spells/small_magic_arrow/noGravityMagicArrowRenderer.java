...
@OnlyIn(Dist.CLIENT)
public class noGravityMagicArrowRenderer extends EntityRenderer<noGravityMagicArrow> {
    private static final ResourceLocation TEXTURE = IronsSpellbooks.id("textures/entity/small_magic_arrow.png");

    public noGravityMagicArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(noGravityMagicArrow entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(noGravityMagicArrow entity) {
