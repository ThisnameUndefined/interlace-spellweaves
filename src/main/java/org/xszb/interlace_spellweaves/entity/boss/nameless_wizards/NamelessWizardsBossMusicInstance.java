...
public class NamelessWizardsBossMusicInstance extends AbstractTickableSoundInstance {
    final NamelessWizardsEntity boss;
    ...
    protected NamelessWizardsBossMusicInstance(NamelessWizardsEntity boss) {
        super(RegistrySound.NAMELESS_WIZARD_LOOP.get(), SoundSource.RECORDS, SoundInstance.createUnseededRandom());
