...
public class Overload extends Enchantment implements IConflictsEnchantment {
    ...
    public Map<Attribute, AttributeConfig> getAttributeConfigs() {
        return Map.of(
                AttributeRegistry.MAX_MANA.get(), new AttributeConfig(-0.1D, 1, AttributeModifier.Operation.MULTIPLY_TOTAL)
        );
    }
}