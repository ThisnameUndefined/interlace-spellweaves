...
public class Elusive extends Enchantment implements IConflictsEnchantment {
    ...
    public Map<Attribute, AttributeConfig> getAttributeConfigs() {
        return Map.of(
                AttributeRegistry.SPELL_POWER.get(), new AttributeConfig(-0.07D, 1, AttributeModifier.Operation.MULTIPLY_BASE)
        );
    }
}